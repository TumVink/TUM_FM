...
def save_hdf5(output_path, asset_dict, attr_dict= None, mode='a'):
    try:
        ...
        print('Error: cannot open file {}'.format(output_path))
        return None
...
def StitchCoords(hdf5_file_path, wsi_object, downscale=16, draw_grid=False, bg_color=(0,0,0), alpha=-1,patch_size=256,patch_level=0):
