...
if __name__ == '__main__':
    ...
    if 'SLN' in args.save_dir:
        ...
        for slide_folder in slide_folder_list:
            if slide_folder == 'LUAD' or slide_folder == 'LUSC':
                sub_file_list = os.listdir(os.path.join(source, slide_folder))
                for file in sub_file_list:
                    file_path = os.path.join(source, slide_folder, file)
                    sub_sub_file_list = os.listdir(file_path)
                    for sub_file in sub_sub_file_list:
                        # print(file)
                        if sub_file.endswith('svs'):
                            # print('yes')
                            print(sub_file)
                            if sub_file in slide_file_name_ls:
                                slide_path = os.path.join(source, slide_folder, file,sub_file)
