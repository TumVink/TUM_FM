...
if __name__ == "__main__":
    ...
    train_dataset = (DatasetMHIST_test(dataset_path = '/mnt/mhist/images/', annot_path='/mnt/mhist/annotations.csv', image_size=224,
    ...
    num_pos, num_neg = train_dataset.get_stats()
    print('num of pos:' + str(num_pos)) # around 1 : 2
